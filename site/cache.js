window.BOARDROOM = {
  ...
  "acts": {
    ...
    "act2_blind": [
      ...
      },
      {
        ...
        "text": "I hold no dataset, by design. My mandate is to build the strongest case against, so here are two challenges to the framing itself. First, anchoring: the $49 figure is borrowed from competitor price lists, not from any evidence that our customers value us at $49 — 'everyone charges more' is what sycophancy sounds like when it wears a spreadsheet. Second, asymmetry: if the increase underperforms, the price can be rolled back, but the customers and trust we lose do not roll back with it. Until this board can name, in numbers, the conditions under which this decision is wrong, my answer is no. Probability that raising the price creates more value than harm: 0.20."
      }
    ],
    "act3_debate": [
      { "speaker": "secretary", "text": "All evidence is now public. Blind review split two in support against three opposed, with probabilities spanning 0.15 to 0.78. Divergence is high. The disagreement is real, so no forced challenge round is required; cross-examination begins now.", "stance": null, "prob": null, "refs": [] },
  ...
  "memo": {
    ...
    "positions": [
      ...
      { "role": "customer_rep", "stance": "conditional", "prob": 0.62, "summary": "Price-sensitive users represent 27% of reviews. Supports only with grandfathering and a visible price-protection promise; remains opposed at 0.35 if everyone is moved to $49." },
